...
export function ChatBottomDrawers({
  ...
  // Determine notification states (disable notifications if request is ended)
  const bargainNotification = !isRequestEnded && currentBargain && (
  ...
  const paymentNotification = !isRequestEnded && currentBargain?.status === 'CONFIRMED' && 
    serviceTransaction && serviceTransaction.paymentStatus === 'PENDING';

  const locationNotification = !isRequestEnded && currentBargain?.status === 'CONFIRMED' && 
    ...
    <>
      ...
      <div className="border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="flex items-center justify-around p-3 gap-2">
          ...
          {!isRequestEnded && currentBargain?.status === 'CONFIRMED' && 
           serviceTransaction?.paymentStatus === 'COMPLETED' && (
